...
2. Memperoleh gambaran end-to-end bagaimana proses OCR invoice dapat dilakukan pada eksplorasi tahap ketiga: [OCR_1_Keras_OCR.ipynb](OCR_1_Keras_OCR.ipynb)
